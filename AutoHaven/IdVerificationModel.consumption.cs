...
namespace AutoHaven
{
    public partial class IdVerificationModel
    {
        /// <summary>
        /// model input class for IdVerificationModel.
        /// </summary>
        ...
        /// <summary>
        /// model output class for IdVerificationModel.
        /// </summary>
        ...
        private static string MLNetModelPath = Path.GetFullPath("IdVerificationModel.mlnet");
        ...
        public static ModelOutput PredictFromImage(string imagePath)
        {
            ...
            var input = new ModelInput()
            {
                ...
                Label = "" // not required at prediction time
            };
